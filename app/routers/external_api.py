...
router = APIRouter(prefix="/external", tags=["外部API"], dependencies=[Depends(get_current_user)], route_class=UnifiedResponseRoute)
...
@router.get("/weather/{city}", response_model=dict[str, Any])
